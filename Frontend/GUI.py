...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        message_button.setStyleSheet ("height:40px; line-height:40px; line-height:40px; background-color:white; color:black")
